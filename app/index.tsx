...
import PrivacyPolicyEnclosure from "@/components/screens/enclosures/PrivacyPolicyEnclosure"
import React, { useState } from "react"
import TermOfAcceptanceEnclosure from "@/components/screens/enclosures/TermOfAcceptanceEnclosure"
...
export default function InfoScreen() {
    ...
    return (
        <PrivacyPolicyEnclosure>
            <TermOfAcceptanceEnclosure>
                <TutorialEnclosure openTutorialAction={() => setTutorialModalOpen(true)}>
                    <Screen flex>
                        ...
                        <Box.Center style={ styles.container }>
                            ...
                            >
                                Uma aplicação que realiza o controle do ciclo do sono e gerenciamento de sonhos.
                            </CustomText>
